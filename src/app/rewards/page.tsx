      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-12">
           ...
           <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                 {badges.map((badge, i) => (
                   <div key={i} className={`p-8 rounded-2xl border transition-all group relative overflow-hidden ${badge.locked ? 'bg-muted/30 grayscale opacity-60' : 'bg-card hover:shadow-xl hover:border-primary'}`}>
        ...
        <div className="space-y-8">
           ...
           <div className="bg-foreground text-background rounded-3xl p-8 shadow-xl">
              ...
              <Button className="w-full mt-8 h-12 bg-primary text-white font-bold  rounded-2xl">
                 Reset in 4h 22m
              </Button>
           </div>
           ...
           <div className="bg-card rounded-2xl border p-8 shadow-sm">
              ...
              <Button variant="outline" className="w-full rounded-xl flex items-center gap-2 font-bold">
                 View Full Leaderboard <ArrowRight className="h-4 w-4" />
              </Button>
           </div>

           {/* Prize Box */}
           <div className="bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl p-8 text-white relative overflow-hidden group cursor-pointer">
