      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-12">
           ...
           <section className="bg-card rounded-3xl border shadow-sm p-8 md:p-12 flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="w-full md:w-64 aspect-square bg-muted/30 rounded-2xl border flex flex-col items-center justify-center p-6 text-center">
                 ...
                 <div className="text-sm font-bold  mb-1 uppercase tracking-widest">Current State</div>
                 <div className="text-xs text-muted-foreground font-bold">"Stay consistent. You're doing great!"</div>
              </div>
           </section>

           {/* Burnout Alert */}
           <section className="bg-red-500 text-white rounded-3xl p-8 md:p-12 shadow-xl relative overflow-hidden group">
              <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
                 <div className="h-24 w-24 rounded-2xl bg-white/20 flex items-center justify-center flex-shrink-0 animate-pulse">
                    <AlertTriangle className="h-12 w-12" />
                 </div>
                 <div className="flex-1">
                    <div className="text-xs font-bold uppercase tracking-[0.2em] mb-2 text-red-100">AI Safety System</div>
                    ...
                    <div className="flex flex-wrap gap-4">
                       <Button className="h-14 px-8 rounded-2xl bg-white text-red-600 font-bold  text-lg shadow-lg">Activate Light Plan 🍃</Button>
        ...
        <div className="space-y-8">
           ...
           <div className="bg-card rounded-2xl border p-8 shadow-sm">
              ...
              <Button className="w-full h-16 bg-orange-500 text-white font-bold  text-xl rounded-2xl shadow-xl shadow-orange-500/20 group">
...
function RelaxationCard({ icon: Icon, title, desc, color }: any) {
  return (
    <div className="bg-card p-8 rounded-2xl border shadow-sm hover:border-primary transition-colors cursor-pointer group">
