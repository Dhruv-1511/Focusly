    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            <motion.span 
              ...
              className="inline-block px-4 py-1.5 mb-8 text-xs font-black tracking-[0.2em] text-primary uppercase bg-primary/10 rounded-lg border border-primary/20"
            >
            ...
            >
              <div className="relative group">
                <div className="absolute -inset-1 bg-linear-to-r from-primary to-secondary rounded-lg blur opacity-25 group-focus-within:opacity-50 transition duration-1000 group-hover:duration-200" />
                <div className="relative flex items-center bg-card rounded-lg border border-border overflow-hidden">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 mt-8">
                ...
                {problems.map((p) => (
                  <Button 
                    ...
                    className="h-10 px-5 rounded-lg bg-muted/50 text-xs font-black hover:bg-primary hover:text-white transition-all border-none"
                  >
                    {p}
                  </Button>
                ))}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Button size="xl" className="h-16 px-10 text-lg font-black rounded-lg shadow-2xl shadow-primary/30 hover:scale-105 active:scale-95 transition-all" asChild>
                <Link href="/planner">Create Study Plan</Link>
              </Button>
              <Button size="xl" variant="outline" className="h-16 px-10 text-lg font-black rounded-lg border-2 hover:bg-muted/50 hover:scale-105 active:scale-95 transition-all" asChild>
        ...
        <div className="absolute top-0 left-0 w-full h-full -z-10 pointer-events-none overflow-hidden">
          <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-primary/10 rounded-lg blur-[120px] animate-pulse" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-secondary/10 rounded-lg blur-[120px] animate-pulse delay-1000" />
          <div className="absolute top-[20%] right-[10%] w-[30%] h-[30%] bg-blue-400/5 rounded-lg blur-[100px] animate-bounce duration-[10s]" />
      ...
      <section className="py-24 border-y bg-muted/20 relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="flex flex-col md:flex-row items-center justify-between gap-10 p-10 md:p-16 glass rounded-lg relative overflow-hidden group shadow-2xl"
          >
             <div className="absolute top-0 right-0 p-8 opacity-20 group-hover:opacity-40 transition-opacity">
                <Sparkles className="h-16 w-16 text-yellow-500 animate-pulse" />
             </div>
             <div className="flex-1 relative z-10">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-primary/10 text-primary font-black text-[10px] uppercase tracking-[0.2em] mb-6">
             ...
             <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto relative z-10">
                <Button variant="outline" size="xl" className="w-full md:w-auto font-black rounded-lg h-16 px-10 border-2" asChild>
                  <Link href="/tools">Learn More</Link>
                </Button>
                <Button variant="secondary" size="xl" className="w-full md:w-auto font-black rounded-lg h-16 px-10 shadow-xl shadow-secondary/20" onClick={() => alert("Daily problem marked as solved!")}>
                  Mark as Solved ✅
                </Button>
             </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                id={feature.id}
                className="group relative p-12 rounded-lg border bg-card hover:border-primary/50 transition-all duration-500 shadow-sm hover:shadow-2xl hover:-translate-y-2 cursor-pointer overflow-hidden"
              ...
              >
                ...
                <div className={cn("w-16 h-16 rounded-lg flex items-center justify-center mb-10 text-white shadow-xl group-hover:scale-110 transition-transform duration-500 relative z-10", feature.color)}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
           <div className="max-w-4xl mx-auto">
              <motion.div 
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-red-50 text-red-600 font-black text-xs mb-10 shadow-sm uppercase tracking-[0.2em] border border-red-100"
              >
              ...
              >
                  ...
                  <div className="flex flex-col sm:flex-row justify-center gap-6 relative z-10">
                    <Button size="xl" className="h-20 px-12 text-xl font-black rounded-lg shadow-2xl shadow-primary/30 hover:scale-105 active:scale-95 transition-all" asChild>
                      <Link href="/focus">Start Focus Session</Link>
                    </Button>
                    <Button size="icon" variant="outline" className="h-20 w-20 rounded-lg border-4 hover:bg-red-50 hover:border-red-200 transition-all group/icon" onClick={() => console.log("Lofi radio toggled")}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
           <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8">
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="lg:col-span-1 p-12 bg-card rounded-lg border shadow-2xl flex flex-col relative overflow-hidden"
              >
                 <div className="absolute top-0 right-0 w-32 h-32 bg-yellow-500/5 rounded-lg -mr-16 -mt-16" />
                 ...
                 <div className="space-y-6 flex-1 relative z-10">
                    {[
                      ...
                      <motion.div 
                        whileHover={{ x: 10 }}
                        key={user.name} 
                        className="flex items-center justify-between p-5 rounded-lg bg-muted/30 border border-transparent hover:border-border hover:bg-card hover:shadow-lg transition-all"
                      >
                        <div className="flex items-center gap-4">
                           <span className="font-black text-muted-foreground text-sm w-4">{i+1}</span>
                           <div className="h-12 w-12 rounded-lg bg-primary/10 flex items-center justify-center text-primary font-black shadow-sm text-lg">{user.name[0]}</div>
                 ...
                 <Button className="w-full mt-10 h-16 font-black rounded-lg text-lg relative z-10" variant="outline" onClick={() => console.log("Opening leaderboards")}>
              ...
              <motion.div 
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="lg:col-span-2 p-12 md:p-20 bg-foreground text-background rounded-lg relative overflow-hidden group shadow-[0_40px_80px_-15px_rgba(0,0,0,0.3)]"
              >
                 <div className="relative z-10 h-full flex flex-col">
                    ...
                    <div className="bg-white/5 backdrop-blur-2xl rounded-lg p-10 border border-white/10 mb-12 flex-1">
                    ...
                    <Button size="xl" className="h-20 px-12 bg-primary text-white hover:bg-primary/90 font-black rounded-lg shadow-2xl shadow-primary/40 self-start text-xl" asChild>
      ...
      <section className="py-40">
         <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center gap-24 max-w-7xl mx-auto">
               ...
               >
                  <div className="inline-block px-5 py-2 rounded-lg bg-blue-50 text-blue-600 font-black text-[10px] mb-10 tracking-[0.3em] uppercase border border-blue-100">WELLNESS CHECK</div>
                  ...
                  <Button size="xl" variant="outline" className="mt-16 h-18 px-10 group font-black rounded-lg border-2 text-lg hover:bg-muted/50 transition-all" asChild>
               ...
               <motion.div 
                ...
                viewport={{ once: true }}
                className="w-full lg:w-1/2 p-12 md:p-20 bg-muted/50 rounded-lg border relative shadow-inner overflow-hidden"
               >
                  <motion.div 
                    whileHover={{ scale: 1.02 }}
                    className="bg-card p-10 rounded-lg shadow-[0_40px_80px_-15px_rgba(0,0,0,0.1)] border-2 mb-10 rotate-3 hover:rotate-0 transition-all duration-700 relative z-10"
                  >
                     ...
                     <div className="flex flex-col sm:flex-row gap-4">
                        <Button size="xl" className="flex-1 h-16 bg-secondary text-white font-black rounded-lg hover:bg-secondary/90 shadow-xl shadow-secondary/20" onClick={() => console.log("Break accepted")}>Accept Break</Button>
                        <Button size="xl" variant="ghost" className="flex-1 h-16 font-black rounded-lg" onClick={() => console.log("Alert ignored")}>Ignore</Button>
                     </div>
                  </motion.div>
                  <div className="absolute top-12 right-12 bg-yellow-400 text-black px-6 py-2 rounded-lg text-xs font-black tracking-[0.2em] shadow-xl z-20">AI COACH</div>
                  <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-primary/10 rounded-lg blur-[100px]" />
               </motion.div>
            </div>
         </div>
      </section>
      ...
      <footer className="py-32 border-t bg-card relative overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="flex items-center justify-center gap-3 mb-10 group cursor-pointer">
            <div className="h-12 w-12 rounded-lg bg-primary flex items-center justify-center shadow-lg shadow-primary/20 group-hover:rotate-12 transition-transform duration-500">
